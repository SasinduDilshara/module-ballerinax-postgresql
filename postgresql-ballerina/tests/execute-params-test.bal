...
function testInsertIntoRangeDataTable4() returns error? {
    ...
    DateRange dateRange = {lower:"2010-01-01" , upper:"2010-01-03"};
...
function testInsertIntoRangeDataTable5() returns error? {
    ...
    time:Civil timestamp1 = {year: 2017, month:2, day: 3, hour: 11, minute: 53, second:0, "utcOffset": {hours: 8, minutes: 30}};
    time:Civil timestamp2 = {year: 2017, month:2, day: 3, hour: 11, minute: 55, second:0, "utcOffset": {hours: 8, minutes: 30}};
    time:Civil timestamp3 = {year: 2016, month:2, day: 3, hour: 11, minute: 53, second:0, "utcOffset": {hours: 8, minutes: 30}};
    time:Civil timestamp4 = {year: 2017, month:2, day: 3, hour: 11, minute: 55, second:0, "utcOffset": {hours: 8, minutes: 30}};

    TimestampRangeToCivil tsRange = {lower: timestamp1 , upper: timestamp2, upperboundInclusive: true};
    TimestamptzRangeToCivil tstzRange = {lower: timestamp3 , upper: timestamp4, lowerboundInclusive: true};
    DateRangeToCivil dateRange = {lower: date1 , upper: date2, lowerboundInclusive: true, upperboundInclusive: true};
