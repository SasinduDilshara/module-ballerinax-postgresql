...
function testRangeProcedureOutCall() returns error? {
    ...
    test:assertTrue(tsrangeInoutValue.get(TimestampRangeToCivil) is TimestampRangeToCivil, "Tsrange Datatype Doesn't Match");
    test:assertTrue(tstzrangeInoutValue.get(TimestamptzRangeToCivil) is TimestamptzRangeToCivil, "Tstzrange Datatype Doesn't Match");
    test:assertTrue(daterangeInoutValue.get(DateRangeToCivil) is DateRangeToCivil, "Daterange Datatype Doesn't Match");
}
